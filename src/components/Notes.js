                    ...
                    <div className="modal-content border-none" style={{ background: "linear-gradient(132deg, rgba(187,148,86,1) 0%, rgba(246,228,128,1) 35%, rgba(246,241,186,1) 60%, rgba(202,175,90,1) 100%)" }}>
                        ...
                        <form action=''>
                            ...
                            <div className="modal-footer border-none pt-0 pb-3">
                                ...
                                <button disabled={note.etitle.length < 3} type="submit" onClick={handleClick} className="w-full h-9 rounded-lg  bg-[#472523] hover:bg-[#321918] text-white" data-bs-dismiss='modal'>Update Note</button>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                {(filteredNotes.length === 0 || !localStorage.getItem('token')) ? (
                    <>
                        ...
                        <p className="mb-8 mt-4">
                            Oops! Your notebook is feeling a bit lonely. Time to add some notes and fill it with your ideas!
                        </p>
                        <button
                            style={{
                                backgroundColor: "#FBAB7E",
                                // backgroundImage: "linear-gradient(62deg, #AE8625 0%, #F7E58A 75%, #F7CE68 100%)"
                                backgroundImage: "linear-gradient(62deg, #AE8625 0%, #F7E58A 75%, #D2AC47 100%)"
                            }}
                    ...
                    <div className='container'>
                        ...
                        <div onClick={handleGetStarted} style={{
                            ...
                            // backgroundImage: "linear-gradient(62deg, #AE8625 0%, #F7E58A 75%, #F7CE68 100%)"
                            backgroundImage: "linear-gradient(62deg, #AE8625 0%, #F7E58A 75%, #D2AC47 100%)"
                        }} data-bs-toggle='modal' data-bs-target='#addNoteModal' className='rounded-full h-16 z-50 fixed right-14 bottom-9 w-16 flex justify-center items-center hover:scale-110 transition-all duration-150 cursor-pointer ease-linear'>
