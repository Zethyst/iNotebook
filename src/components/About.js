  ...
  return (
    <>
      <div className=' flex justify-center items-center m-2'>
        <div className='w-[90%] md:w-[70%] md:h-[80vh] flex flex-col md:flex-row gap-5 justify-center items-center p-10 my-2' style={{ boxShadow: "0 1px 20px 0 rgba(0, 0, 0, 0.1)", borderRadius: "32px" }}>
